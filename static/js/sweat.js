...
function zamena(element){
    ...
    if(element.id == "img1") {
        a.src="/static/image/sweat1.png";
    }
    else if(element.id == "img2"){
        a.src="/static/image/sweat2.png";
    }
    else if(element.id == "img3"){
        a.src="/static/image/sweat3.png";
    }
    else if(element.id == "img4"){
        a.src="/static/image/sweat4.png";
    }
    else if(element.id == "img5"){
        a.src="/static/image/sweat5.png";
    }
    else if(element.id == "img6"){
        a.src="/static/image/sweat6.png";
    }
}