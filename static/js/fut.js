...
function zamena(element){
    ...
    if(element.id == "img1") {
        a.src="/static/image/fut5norm.png";
    }
    else if(element.id == "img2"){
        a.src="/static/image/fut3norm.png";
    }
    else if(element.id == "img3"){
        a.src="/static/image/fut1norm.png";
    }
    else if(element.id == "img4"){
        a.src="/static/image/fut4norm.png";
    }
    else if(element.id == "img5"){
        a.src="/static/image/fut2norm.png";
    }
